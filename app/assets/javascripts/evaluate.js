require(['bind', 'module_struct', 'compat/observe', 'el/el', 'domReady!'],
function(bind, module, _proxy, el) {
'use strict';
    ...
    initialize() {
        ...
        test_info.questions.forEach(
            (question, index) => {
                ...
                case 'mas':
                    this.question_controllers[index] = new MCQQuestionController(question);
                    this.model.question_controllers[index] = this.question_controllers[index].model;
                    break;
                case 'sbt':
